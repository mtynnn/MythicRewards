...
public class LanguageManager {
    ...
    private void initLanguages() {
        File langFolder = new File(MythicRewards.instance.getDataFolder(), "languages");
    ...
    private String getMessage(Player player, String key, String... args) {
        ...
        text = text.replace("{plugin_folder}", String.valueOf(MythicRewards.instance.getDataFolder()));
        return text;
    }

    private void saveLanguageFile(String lang, YamlConfiguration config) {
        File file = new File(MythicRewards.instance.getDataFolder(), "languages/" + lang + ".yml");
        try {
            config.save(file);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private YamlConfiguration loadInternalLanguage(String language) {
        ...
        InputStream inputStream = MythicRewards.instance.getResource("languages/" + resourceName + ".yml");
        if (inputStream == null) {
            return null;
        }
